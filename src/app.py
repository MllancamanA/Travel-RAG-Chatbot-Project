...
# ====================
st.markdown("🔍 Ask Your Travel Questions")  # HINT: "🔍 Ask Your Travel Questions"

# HINT: Example questions in 3 columns
col1, col2, col3 = st.columns(3)
with col1:
    if st.button("✈️ Baggage Rules"):  # HINT: "✈️ Baggage Rules"
...
if 'example_query' in st.session_state:
    ...
    query_text = st.text_input(
        ...
        placeholder="What are the baggage rules for BLR to LON?",  # HINT: "e.g., 'What are the baggage rules for BLR to LON?'"
...
if search_button and engine and query_text:
    ...
    st.warning("⚠️ Please enter a travel question.")  # HINT: "⚠️ Please enter a travel question."